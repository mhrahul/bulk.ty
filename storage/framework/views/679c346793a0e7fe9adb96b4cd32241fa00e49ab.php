...
<body>
    ...
    ?>
        ...
        if (isset($user_meta['temp_user'])) {
            ...
            ?>
                ...
                <div class="auth-container" style="position: fixed;z-index: 555000;background: #f5f5f5;width: 100%;margin: 0 auto;top: 0;bottom: 0;">
                    <div class="panel">

                        <form id="update-temp-user" class="form-horizontal" role="form" method="POST" action="https://app.bulk.ly/update-temp-user" style="position: absolute;width: 100%;max-width: 600px;background: #ffffff;padding: 30px;transform: translate(-50%, -50%);top: 50%;left: 50%;">
    ...
    <noscript>
        <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TLNT7S" height="0" width="0" style="display:none;visibility:hidden"></iframe>
    </noscript>
        ...
        <nav class="navbar left-navbar">
            <div class="container-fluid">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li <?php if($route=='history' ): ?> class="active" <?php endif; ?>><a href="<?php echo e(url('/history')); ?>"> <i class="fa fa-home"></i> History</a></li>
                    <?php endif; ?>
                </ul>
            </div><!-- /.container-fluid -->
        </nav>
